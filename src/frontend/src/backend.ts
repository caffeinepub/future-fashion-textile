...
import type { Project as _Project, ProjectCategory as _ProjectCategory, ProjectId as _ProjectId, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProject(arg0: string, arg1: string, arg2: ProjectCategory, arg3: string): Promise<ProjectId> {
        if (this.processError) {
            try {
                const result = await this.actor.createProject(arg0, arg1, to_candid_ProjectCategory_n3(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllContacts(): Promise<Array<ContactMessage>> {
        if (this.processError) {
            try {
    ...
    async listProjects(arg0: ProjectCategory | null): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.listProjects(to_candid_opt_n12(this._uploadFile, this._downloadFile, arg0));
    ...
    async markContactAsRead(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProject(arg0: ProjectId, arg1: string, arg2: string, arg3: ProjectCategory, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProject(arg0, arg1, arg2, to_candid_ProjectCategory_n3(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ProjectCategory_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProjectCategory): ProjectCategory {
    return from_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function from_candid_Project_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Project): Project {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: from_candid_ProjectCategory_n10(_uploadFile, _downloadFile, value.category)
    };
}
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "graphicDesign" in value ? ProjectCategory.graphicDesign : "uiUx" in value ? ProjectCategory.uiUx : "branding" in value ? ProjectCategory.branding : value;
}
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Array<Project> {
    return value.map((x)=>from_candid_Project_n8(_uploadFile, _downloadFile, x));
}
...
function to_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectCategory | null): [] | [_ProjectCategory] {
    return value === null ? candid_none() : candid_some(to_candid_ProjectCategory_n3(_uploadFile, _downloadFile, value));
}
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectCategory): {
    ...
    return value == ProjectCategory.graphicDesign ? {
        graphicDesign: null
    } : value == ProjectCategory.uiUx ? {
        uiUx: null
    } : value == ProjectCategory.branding ? {
        branding: null
    } : value;
}
